...
- Student portal:
  ...
  - **PDF Papers**: AI-generates 5 unique MCQs per paper (via OpenAI) with watermark, answer key, branding; level-aware prompts; validated output; "Want more?" flow after generation

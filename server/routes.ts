...
export async function registerRoutes(
  ...
  app.post("/api/chatbot", async (req, res) => {
    ...
    if (isGreeting) {
      ...
      if (college?.feeStructure) reply += `\n\n**Fee Structure:** ${college.feeStructure}`;
      if (college?.applyLink) reply += `\n\n**Website:** [${college.applyLink}](${college.applyLink})`;
    } else if (lowerMsg.includes("difference") || lowerMsg.includes("compare") || (lowerMsg.includes("best") && (lowerMsg.includes("college") || lowerMsg.includes("cadet"))) || lowerMsg.includes("konsa") || lowerMsg.includes("which college") || lowerMsg.includes("ranking") || (lowerMsg.includes("top") && lowerMsg.includes("college"))) {
      reply = "Beta, yeh bohat common sawal hai! 😊 Main tumhe guide karta hoon:\n\n**Top Cadet Colleges Ranking (Reputation-wise):**\n\n🥇 **Tier 1 — Most Prestigious:**\n- Cadet College Hasan Abdal (Punjab) — 'Eton of Pakistan'\n- Lawrence College Ghora Gali (Murree)\n- Cadet College Petaro (Sindh)\n\n🥈 **Tier 2 — Excellent:**\n- Military College Jhelum\n- PAF College Sargodha\n- PAF Cadet College Murree Lower Topa\n- Cadet College Kohat\n- Cadet College Razmak\n\n🥉 **Tier 3 — Very Good:**\n- Cadet College Fateh Jang\n- Cadet College Mastung\n- Cadet College Lahore\n- Military College Sui\n\n**Choosing the Right College:**\n- Location & proximity to home\n- Fee structure & affordability\n- Entry class available (8th, 11th, etc.)\n- College reputation & alumni network\n- Facilities & environment\n\n**Remember:** Every cadet college provides excellent discipline and education. The 'best' college is the one where YOU can perform your best! 💪\n\nKisi specific college ke baare mein poochna ho toh naam batao! 😊";
    } else if (lowerMsg.includes("sport") || lowerMsg.includes("game") || lowerMsg.includes("cricket") || lowerMsg.includes("football") || lowerMsg.includes("hockey") || lowerMsg.includes("khel")) {
      reply = "Beta, cadet colleges mein sports ki bohat importance hai! 😊\n\n**Sports & Co-curricular Activities:**\n\n🏏 **Major Sports:**\n- Cricket, Football, Hockey\n- Basketball, Volleyball\n- Tennis, Badminton, Table Tennis\n- Athletics (running, long jump, high jump)\n- Swimming (in colleges with pool facilities)\n- Boxing, Martial Arts\n\n🎯 **Military Activities:**\n- Drill and Parade practice\n- Shooting range (some colleges)\n- Obstacle courses\n- Adventure activities — camping, hiking, trekking\n- Horse riding (select colleges like Lawrence)\n\n🎭 **Extra Activities:**\n- Debating competitions\n- Quiz competitions\n- Drama and theatre\n- Art and calligraphy\n- Music band\n- Science exhibitions\n- Scouts\n\n🏆 **Inter-College Competitions:**\n- Annual sports day\n- Inter-cadet college tournaments\n- National level competitions\n- ISSB-style group tasks\n\nSports daily schedule mein included hota hai — usually **4:00-6:00 PM**. Har cadet ko at least ek sport mein participate karna hota hai! 💪\n\nKoi aur sawal? 😊";
    } else if (lowerMsg.includes("result") || lowerMsg.includes("merit") || lowerMsg.includes("selection") || lowerMsg.includes("selected") || (lowerMsg.includes("pass") && !lowerMsg.includes("password"))) {
      reply = "Beta, result aur merit ke baare mein batata hoon! 😊\n\n**Entry Test Results & Merit:**\n\n📊 **How Merit is Calculated:**\n- Written test score (70-80% weightage)\n- Interview performance (10-15% weightage)\n- Medical fitness (Pass/Fail — no marks)\n- Previous academic record (5-10% in some colleges)\n\n📋 **Result Process:**\n1. Written test results announced first (2-4 weeks after test)\n2. Shortlisted candidates called for interview\n3. After interview — medical test\n4. Final merit list announced\n5. Waiting list bhi hoti hai\n\n**Tips for Good Result:**\n- Score 70%+ in written test for safe zone\n- Top 2-3x the available seats are usually called for interview\n- Medical mein fit hona zaroori hai\n- Interview mein confident aur honest raho\n\n**Competition:**\n- Roughly 10-15 candidates compete for each seat\n- Top colleges like Hasan Abdal have higher competition\n- Government/subsidized colleges have more applicants\n\nMehnat karo beta, InshAllah result acha aayega! 💪\n\nHumare portal par [register karo](/register) aur mock tests se apna score check karo — pehle **3 din FREE**! 😊";
    } else if (lowerMsg.includes("document") || lowerMsg.includes("application form") || lowerMsg.includes("admission form") || lowerMsg.includes("kagaz") || lowerMsg.includes("kya chahiye") || lowerMsg.includes("submit")) {
      reply = "Beta, admission ke liye yeh documents chahiye honge! 😊\n\n**Required Documents:**\n\n📄 **Essential Documents:**\n- Birth Certificate (original + photocopy)\n- B-Form / CNIC (if 15+ years)\n- Previous class result card / marksheet\n- School Leaving Certificate (SLC)\n- Character certificate from school\n- Domicile certificate\n- Father/Guardian's CNIC (photocopy)\n- 6-8 passport-size photographs (white background)\n\n📋 **Additional Documents:**\n- Nishan-e-Haider / Tamgha-e-Imtiaz certificate (for armed forces children concession)\n- Income certificate (for scholarship)\n- Medical fitness certificate (from registered doctor)\n- Hafiz-e-Quran certificate (if applicable — some colleges give extra marks)\n\n💡 **Tips:**\n- Get all documents attested/verified beforehand\n- Keep multiple photocopies of everything\n- Original documents wapas mil jaate hain after verification\n- Check specific college's prospectus for their exact requirements\n- Photographs should be recent (within 3 months)\n\nKisi specific college ke liye documents chahiye toh naam batao! 😊\n\nYa WhatsApp karo: [+923348480890](https://wa.me/923348480890)";
    } else if (lowerMsg.includes("test date") || lowerMsg.includes("exam date") || ((lowerMsg.includes("kab") || lowerMsg.includes("when")) && (lowerMsg.includes("test") || lowerMsg.includes("exam") || lowerMsg.includes("admission") || lowerMsg.includes("date") || lowerMsg.includes("last") || lowerMsg.includes("result")))) {
      const colleges = await storage.getColleges();
      const withDates = colleges.filter(c => c.lastApplyDate);
      let dateInfo = "";
      if (withDates.length > 0) {
        dateInfo = "\n\n**Known Upcoming Dates:**\n" + withDates.map(c => `- **${c.name}**: Last date ${new Date(c.lastApplyDate!).toLocaleDateString("en-PK", { day: "numeric", month: "long", year: "numeric" })}`).join("\n");
      }
      reply = `Beta, cadet college tests ki dates ke baare mein batata hoon! 😊\n\n**General Test Schedule:**\n\n📅 **Admissions Usually Announced:** January - March\n📅 **Entry Tests Usually Held:** March - May\n📅 **Results:** April - June\n📅 **New Session Starts:** August - September\n\n**Important Notes:**\n- Each college announces its own dates separately\n- Keep checking college websites and newspapers\n- Some colleges have online applications now\n- Late applications usually accepted with extra fee${dateInfo}\n\n**Stay Updated:**\n- Follow our portal for date announcements\n- WhatsApp updates: [+923348480890](https://wa.me/923348480890)\n\nKisi specific college ki date chahiye toh naam batao! 😊`;
    } else if (lowerMsg.includes("hostel") || lowerMsg.includes("boarding") || lowerMsg.includes("room") || lowerMsg.includes("mess") || lowerMsg.includes("food") || lowerMsg.includes("khana")) {
      reply = "Beta, cadet colleges mein hostel life bohat organized hoti hai! 😊\n\n**Hostel & Boarding Life:**\n\n🏠 **Accommodation:**\n- Shared dormitories (8-12 cadets per room initially, 2-4 in senior classes)\n- Clean bedding, almirah for clothes, study table\n- Proper ventilation and fans/AC (varies by college)\n\n🍽️ **Mess & Food:**\n- 3 meals daily + evening snacks\n- Balanced diet — roti, rice, dal, sabzi, meat, fruits\n- Special meals on Fridays and national days\n- Clean drinking water available\n\n⏰ **Daily Routine:**\n- 5:00 AM — Fajr prayer & morning PT (exercise)\n- 7:00 AM — Breakfast\n- 8:00 AM - 2:00 PM — Classes\n- 2:00 PM — Lunch & rest\n- 4:00 PM — Sports & co-curricular activities\n- 7:00 PM — Dinner\n- 8:00 PM - 10:00 PM — Prep time (supervised study)\n- 10:00 PM — Lights out\n\n👕 **Uniform:**\n- Formal uniform for classes\n- PT kit for exercise & sports\n- Mess dress for dining\n- All provided by the college\n\nHostel life discipline aur independence dono sikhati hai! 💪\n\nKoi aur sawal ho toh pooch lo beta! 😊";
    } else if (lowerMsg.includes("scholarship") || lowerMsg.includes("concession") || lowerMsg.includes("discount") || lowerMsg.includes("free seat") || lowerMsg.includes("ghareeb") || lowerMsg.includes("garib")) {
      reply = "Beta, bohat achi baat poochi! 😊 Cadet colleges mein scholarships aur concessions available hain:\n\n**Scholarships & Fee Concessions:**\n\n🎓 **Merit-Based Scholarships:**\n- Top scorers in entry test get fee waivers\n- Some colleges offer 25-100% fee concession on merit\n- Annual merit scholarships for class toppers\n\n👨‍✈️ **Armed Forces Children:**\n- Serving/retired Army, Navy, Air Force personnel children get 20-50% concession\n- Shaheed/martyred soldiers' children often get full scholarships\n- JCOs and soldiers get higher concessions than officers\n\n🏠 **Need-Based:**\n- Colleges have funds for deserving students\n- Zakat funds available in some colleges\n- NGO sponsorships in certain institutions\n\n🌍 **Regional Quotas:**\n- Balochistan, FATA/tribal area students get special concessions\n- Government-subsidized colleges have lower fees for local domicile holders\n- Some colleges reserve seats for underprivileged areas\n\n**How to Apply for Scholarship:**\n1. Mention in admission form\n2. Provide income certificate of father/guardian\n3. Some require separate scholarship application\n4. Keep academic record strong!\n\nMazeed details ke liye specific college ka naam batao ya WhatsApp karo: [+923348480890](https://wa.me/923348480890) 😊";
    } else if (lowerMsg.includes("uniform") || lowerMsg.includes("dress") || lowerMsg.includes("wardi") || lowerMsg.includes("kapre")) {
      reply = "Beta, cadet college ki uniform bohat smart hoti hai! 😊\n\n**Cadet College Uniforms:**\n\n👔 **Daily Uniform:**\n- White/cream shirt with college crest\n- Grey/khaki trousers\n- Black shoes (polished!)\n- College tie and belt\n- Blazer with college badge (for formal occasions)\n\n🏃 **PT (Physical Training) Kit:**\n- White T-shirt with college logo\n- Blue/black track pants\n- Sports shoes\n- Shorts for athletics\n\n🎖️ **Parade Uniform:**\n- Formal military-style uniform\n- Beret/cap with badge\n- White gloves for special occasions\n- Ceremonial belt\n\n🍽️ **Mess Dress:**\n- Smart casual for dining hall\n- Usually different from class uniform\n\n**Important:**\n- Most colleges provide the first set of uniforms\n- Additional sets may need to be purchased\n- Keep your uniform clean and pressed — it's part of discipline!\n- Black socks and white vest are usually required\n\nKoi aur sawal ho toh pooch lo! 😊";
    } else if ((lowerMsg.includes("college") && (lowerMsg.includes("list") || lowerMsg.includes("all") || lowerMsg.includes("how many") || lowerMsg.includes("kitne") || lowerMsg.includes("naam"))) || lowerMsg === "colleges") {
      const colleges = await storage.getColleges();
      const provinces = await storage.getProvinces();
      const pkProvinces = provinces.filter(p => p.country === "Pakistan");
      const provinceMap = new Map(pkProvinces.map(p => [p.id, p.name]));
      const grouped: Record<string, string[]> = {};
      colleges.forEach(c => {
        const pName = provinceMap.get(c.provinceId);
        if (!pName) return;
      ...
      const allColleges = await storage.getColleges();
      const commonWords = ["the", "and", "for", "with", "best", "good", "new", "old", "north", "south", "east", "west", "royal", "king", "international"];
      const matchedCollege = allColleges.find(c => {
        const cName = c.name.toLowerCase();
        const cCity = (c.city || "").toLowerCase();
        const nameWords = cName.replace(/cadet|college|military|school|pakistan|paf|pn|academy/g, "").trim().split(/\s+/).filter(w => w.length > 3 && !commonWords.includes(w));
        const nameMatch = nameWords.length > 0 && nameWords.some(w => lowerMsg.includes(w));
        const cityMatch = cCity.length > 3 && lowerMsg.includes(cCity);
        return nameMatch || cityMatch;
      });
      ...
      if (matchedCollege) {
        reply = `**${matchedCollege.name}**\n\n`;
        if (matchedCollege.city) reply += `📍 **Location:** ${matchedCollege.city}\n`;
        if (matchedCollege.admissionClasses) reply += `🎓 **Admission Classes:** ${matchedCollege.admissionClasses}\n`;
        if (matchedCollege.contactNumber) reply += `📞 **Contact:** ${matchedCollege.contactNumber}\n`;
        if (matchedCollege.feeStructure) reply += `\n**Fee Structure:** ${matchedCollege.feeStructure}\n`;
        if (matchedCollege.applyLink) reply += `\n🌐 **Website:** [${matchedCollege.applyLink}](${matchedCollege.applyLink})`;
        reply += "\n\nKoi aur sawal ho is college ke baare mein? Pooch lo beta! 😊";
      } else {
        reply = `Bohat acha sawal hai beta! 😊\n\nMain tumhe in topics mein madad kar sakta hoon:\n- **Admissions** — dates, requirements, process\n- **Entry Test** — syllabus, pattern, tips\n- **Colleges** — list, details, locations, rankings\n- **Fees** — college-wise fee structure\n- **Scholarships** — concessions, merit-based aid\n- **Interview** — common questions, preparation\n- **Medical** — physical standards, tests\n- **Hostel Life** — routine, food, uniform\n- **Documents** — required papers for admission\n- **Preparation** — online daily tests, quizzes, AI tutoring\n\nKisi bhi topic ke baare mein pooch lo, main detail mein bataonga! 😊\n\nAur agar test ki tayyari karni hai toh [register karo](/register) — pehle **3 din FREE trial** hai! 💪`;
      }
    } else {
      reply = `Beta, is waqt mere paas is sawal ka jawab nahi hai 😊 Lekin fikar mat karo!\n\nMain cadet college se related bohat se topics mein madad kar sakta hoon:\n- Admissions, eligibility & documents\n- Entry test syllabus & preparation\n- College information & rankings\n- Fee structures & scholarships\n- Interview & medical ki tayyari\n- Hostel life, uniform, sports\n- Online preparation — daily tests, quizzes, AI tutor\n\nAgar tumhara sawal kisi aur topic se hai ya zyada detail chahiye, toh humse directly baat karo:\n\n📱 **WhatsApp:** [+923348480890](https://wa.me/923348480890)\n🌐 **Website:** [www.pakshaheens.com](https://www.pakshaheens.com)\n\nHum tumhari zaroor madad karenge, InshAllah! 🤲`;
    }
